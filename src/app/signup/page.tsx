    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4">
      <div className="bg-white p-8 rounded-2xl shadow-xl max-w-md w-full border border-slate-100">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-slate-900">Créer mon agence</h1>
          <p className="text-slate-500 text-sm mt-1">Première connexion à Tuina Delivery</p>
        </div>
        ...
        <p className="text-center text-sm text-slate-500 mt-6">
          Déjà un compte ? <Link href="/login" className="text-brand-600 hover:underline font-medium">Se connecter</Link>
        </p>
      </div>
    </div>
  );
